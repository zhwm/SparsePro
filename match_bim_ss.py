...
parser = argparse.ArgumentParser(description='Match GWAS and QTL summary statistics with bim file')
...
parser.add_argument('--SE', type=str, default=None, nargs='+', help='column names for effect size standard error',
                    required=True)
...
parser.add_argument('--POS', type=str, default=None, nargs='+', help='column names for position')
...
parser.add_argument('--cols', type=str, default=None, nargs='+', help='columns in output', required=True)
